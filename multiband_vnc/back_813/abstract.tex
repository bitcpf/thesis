...
a shift in frequency from hundreds of MHz to a few GHz and the resulting effects in 
various environments.
In this paper, we leverage the contextual information and propagation diversity to enable
adaptation across a number of frequency bands from 450 MHz to 5.8 GHz.  To do so, we
